class FruitsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @fruit.save
        format.html { redirect_to @fruit, notice: 'Fruta agregada.' }
  ...
  def update
    respond_to do |format|
      if @fruit.update(fruit_params)
        format.html { redirect_to @fruit, notice: 'Fruta actualizada.' }
  ...
  def destroy
    @fruit.destroy
    respond_to do |format|
      format.html { redirect_to fruits_url, notice: 'Fruta eliminada.' }
  ...
  private
    ...
    def fruit_params
      params.require(:fruit).permit(:tipo, :descripcion, :precio)
    end
end
