...
class CraftsControllerTest < ActionController::TestCase
  ...
  test "should create craft" do
    assert_difference('Craft.count') do
      post :create, craft: { costo: @craft.costo, descripcion: @craft.descripcion, fecha: @craft.fecha, materiales: @craft.materiales }
    end
  ...
  test "should update craft" do
    patch :update, id: @craft, craft: { costo: @craft.costo, descripcion: @craft.descripcion, fecha: @craft.fecha, materiales: @craft.materiales }
    assert_redirected_to craft_path(assigns(:craft))
  end
